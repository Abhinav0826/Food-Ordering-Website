...
<body>
    ...
    <div class="restname"><h1 class="rest1">Cream Stone</h1><p class="rest2">Uppal, 1.8 Km</p></div>
    <div class="card">
        <h1>Cart</h1>
    ...
    <div class="dd" id="stay">
        ...
        <a class="dd2"href="http://localhost/demo/cart page2/logout.php"><p class="dd3">Sign Out</p></a>
    </div>
