...
<head>
    ...
    <link rel="stylesheet" href="book.css?v=7">
...
<body>
    <nav>
        ...
        <!-- <div class="popup" id="signin"> -->
            ...
            <div class="info">
              <div class="top"><h1 class="head">Dominos</h1><p class="bot">Kothapet, 1.4 Km</p></div>
              <img src="1.webp" class="picy" alt="">
              <h1 class="add1">Address</h1>
              <p class="add2">11-12 250/2, Road No. 5, Ramakrishnapuram, Kothapet, Hyderabad,<br>Telangana 500035</p>
              <h1 class="tim1">Open from</h1>
              <p class="tim2">1:00 PM - 12:00 AM</p>
            </div>
        </div>
