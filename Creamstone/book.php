...
<body>
    <nav>
        ...
        <ul>
            ...
            <li><a class = "cont" href="http://localhost/demo/home/signin.php">Sign In</a></li>
        </ul>
        ...
        <!-- <div class="popup" id="signin"> -->
            <div class="center">
                ...
                <form action="mail.php" method="post">
                  ...
                  <!-- <input type="submit" value="Book" name="login" onclick="togglex()"> -->
                  <div onclick="toggle3()" class="sub"><p  class="insub">Book</p></div>
                </form>
              </div>
            <div class="info">
              <div class="top"><h1 class="head">Cream Stone</h1><p class="bot">Uppal, 1.8 Km</p></div>
              <img src="1.avif" class="picy" alt="">
              <h1 class="add1">Address</h1>
              <p class="add2"> Vijayapuri Colony, Ring Road Uppal Opposite Uppal New Metro Station<br>East Hyderabad, Telangana 500039</p>
              <h1 class="tim1">Open from</h1>
              <p class="tim2">10:00 AM - 12:00 AM</p>
            </div>
        </div>
